...
class ProcessBookingQueue extends Command
{
     ...
     * @var string
     */
    protected $signature = 'queue:process-bookings {--trip-id= : Process queue for specific trip} {--cleanup : Clean up old queue items}';
    ...
    public function handle()
    {
        if ($this->option('cleanup')) {
            $this->info('Cleaning up old queue items...');
